            ...
            <div className="max-w-4xl mx-auto px-6 sm:px-8">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4 mb-4">
                        ...
                        <a href="#" aria-label="Instgram" className="hover:text-primary-600">
                ...
                <div className="mt-8 text-center text-sm text-gray-500 flex justify-center gap-4">
                    <span>&copy; 2025 RENTIFUL. All rights reserved.</span>
